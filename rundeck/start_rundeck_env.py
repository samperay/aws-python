...
print("list of ec2 instances starting..", rundeck_env_instances)
print('starting rundeck environment instances  ..')
aws_ec2_resource.instances.start()
waiter = aws_ec2_client.get_waiter('instance_running')
waiter.wait(InstanceIds=rundeck_env_instances)
print('all your rundeck environment instances started ..')